...
export const projectData: projectType[] = [
  ...
  },
  {
    ...
    techstack: "VHDL",
    description:
      "I developed a detailed cache controller system using VHDL for a course. This system is defined by a state diagram that includes several states such as Idle, Dispatcher, Read Hit, and Write Hit, each designed for specific cache operations. The CPU was implemented with VIO, and both the cache and main memory were built as BRAM modules, modified to fit the project board's specifications. A crucial feature of this project is the hit or miss function, a combinational circuit that continuously determines hit or miss situations. Moving forward, my plan is to modularize the code, with a specific focus on the finite state machine and the hit or miss functions. This project, utilizing chipscope for simulations, demonstrates my skills in complex hardware programming and intricate design.",
